                    ...
                    for pages_folder_path in pages_folders_paths:
                        ...
                        for root, dirs, files in os.walk(pages_folder_path):
                            ...
                            for file in files:
                                ...
                                # template_object = get_template(file_path)
                                # template = template_object.render()
                                ...
                                webpack_config_file.write(f"""// Don't modify this file, it is generated by a Python script (see sftp_and_cdn.management.commands.handlestatic.py)
